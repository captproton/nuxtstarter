<template>
	<main>
		<div class="page-headline theme-services">
	    <div class="container">
	        <h1 class="text-center text-uppercase">Services</h1>
	        <p>As a full-service digital agency built for the now,<br>
			we’ve grown our practices on what will drive results in today’s mobile landscape:</p>
	    </div>
	    <!--  -->
		<section class="container theme-services" id="theme-services">
			<ul>
...
color: #3d3b3b;
	...
	main {
		...
		grid-template-columns: 
			repeat(auto-fit, minmax(240, 1fr))
	}
	...
	.service-summary-icon >a {
		text-decoration: none;
		display: inline;
		padding-bottom: 0.33em;
	}
	.service-summary-icon > a > img {
		max-width: 100px;
		margin: 0 auto;
	}
